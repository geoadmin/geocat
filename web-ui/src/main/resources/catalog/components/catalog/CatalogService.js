  ...
  module.factory('Metadata', [
    ...
    Metadata.prototype = {
      translateMultilingualObjects: function (multilingualObjects) {
        var mlObjs = angular.isArray(multilingualObjects) ? multilingualObjects : [multilingualObjects]
        mlObjs.forEach(function (mlObj) {
          mlObj.default = mlObj['lang' + gnLangs.current]
            || mlObj.default
      ...
      translateCodelists: function (index) {
        ...
        codelists.forEach(function (mlObj) {
          mlObj.default = mlObj['lang' + gnLangs.current]
            || (($translate.instant(mlObj.key) != mlObj.key) && $translate.instant(mlObj.key))
            || mlObj.default;
        })
      },
      ...
      translateMultingualFields: function (index) {
        for (var fieldName in index) {
          ...
          if (fieldName.endsWith('Object')) {
            ...
            index[fieldName.replace(/Object$/g, '')] =
              angular.isArray(field) ? field.map(function (mlObj) {
