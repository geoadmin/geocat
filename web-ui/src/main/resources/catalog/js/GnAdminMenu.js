...
(function () {
  ...
  module.factory("gnAdminMenu", function () {
    var userAdminMenu = [
      ...
      { name: "settings", route: "#settings", classes: "btn-warning", icon: "fa-gear" }
    ];
    var menu = {
      ...
      Administrator: [
        ...
        { name: "settings", route: "#settings", classes: "btn-warning", icon: "fa-gear" },
        { name: "tools", route: "#tools", classes: "btn-warning", icon: "fa-medkit" }
      ]
