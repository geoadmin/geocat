...
public class SchemaLoader
{
	...
	public MetadataSchema load(String xmlSchemaFile, String xmlSubstitutionsFile, SchematronRepository schemaRepo) throws Exception
	{
		ssOverRides = new SchemaSubstitutions(xmlSubstitutionsFile);

		if (!new File(xmlSchemaFile).exists()) return new MetadataSchema(schemaRepo);
		...
		MetadataSchema mds = new MetadataSchema(schemaRepo);
