...
import static org.fao.geonet.geocat.kernel.extent.ExtentHelper.reducePrecision;
...
public enum ExtentFormat
{
            ...
            throws Exception
    {
        ...
        try {
            ...
            if (attribute != null) {
                descElem = LangUtils.toIsoMultiLingualElem(appPath, ExtentHelper.decodeDescription(attribute));
            }
            if (descElem == null) {
                // making a desc object always present. Mostly a hack to make
                // editing easier
                descElem = LangUtils.toIsoMultiLingualElem(appPath, " ");
            }
    ...
    private static Element createGeoIdElem(String appPath, String attribute) throws Exception
    {
        ...
        if (attribute != null && attribute.trim().length() > 0) {
            ...
            List<Content> content = new ArrayList<Content>(LangUtils.toIsoMultiLingualElem(appPath,
