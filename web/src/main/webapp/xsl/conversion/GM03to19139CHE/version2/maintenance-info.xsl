...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template mode="MaintenanceInfo" match="int:metadataMaintenance|int:GM03_2Comprehensive.Comprehensive.MD_MaintenanceInformation">
        <che:CHE_MD_MaintenanceInformation gco:isoType="gmd:MD_MaintenanceInformation">
            ...
            <xsl:apply-templates mode="MaintenanceInfo" select="int:GM03_2Comprehensive.Comprehensive.MD_HistoryConcept"/>
            <xsl:apply-templates mode="MaintenanceInfo" select="int:GM03_2Comprehensive.Comprehensive.MD_ArchiveConcept"/>
...
<!--            <xsl:attribute name="uuidref"><xsl:value-of select="."/></xsl:attribute>-->
    ...
    <xsl:template mode="MaintenanceInfo" match="int:GM03_2Comprehensive.Comprehensive.MD_ArchiveConcept">
        <che:archiveConcept>
            <che:CHE_MD_ArchiveConcept>
                <xsl:apply-templates select="int:GM03_2Comprehensive.Comprehensive.MD_ArchiveConceptarchiveConceptCitation" mode="MaintenanceInfo"/>
                <xsl:apply-templates select="int:archiveConceptURL" mode="MaintenanceInfo"/>
            </che:CHE_MD_ArchiveConcept>
        </che:archiveConcept>
    </xsl:template>
    <xsl:template mode="MaintenanceInfo" match="int:GM03_2Comprehensive.Comprehensive.MD_ArchiveConceptarchiveConceptCitation">
