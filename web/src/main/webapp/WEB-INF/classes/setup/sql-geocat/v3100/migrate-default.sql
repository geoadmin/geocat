...
ALTER TABLE Sources ADD COLUMN type character varying(255);
...
-- CREATE TABLE metadata_gml302 AS SELECT * FROM metadata;
-- Changes related to INSPIRE TG2 - to be discussed if it has to be applied to che or not
