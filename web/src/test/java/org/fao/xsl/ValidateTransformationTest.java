...
public class ValidateTransformationTest {
    ...
    public void iso19139NewLangCodeTransform() throws Throwable {
        ...
        rules.put("GM03_2_1Comprehensive.Comprehensive.MD_DataIdentification", new Exists(new Finder("language",
                new EqualTrimText("fr"))));
    ...
    @Test
    public void exportPortrayalUrl() throws Throwable {
        File file = new File(data, "iso19139/one.xml");
        Multimap<String, Requirement> rules = ArrayListMultimap.create();
        rules.put("GM03_2_1Comprehensive.Comprehensive.MD_PortrayalCatalogueReference", new Exists(new Finder("portrayalCatalogueURL")));
        testFile(file, Control.ISO_GM03, rules, false);
    }
    ...
    public void exportThesaurusTitle() throws Throwable {
        ...
        rules.put("TRANSFER/DATASECTION/GM03_2_1Comprehensive.Comprehensive", new Count(1,
                new Finder("GM03_2_1Core.Core.MD_Thesaurus/citation")));
        file = testFile(file, Control.ISO_GM03, rules, true);

        rules.clear();
        rules.put("CHE_MD_Metadata/identificationInfo/CHE_MD_DataIdentification", new Count(1,
                new Finder("descriptiveKeywords/MD_Keywords/keyword")));
        rules.put("CHE_MD_Metadata/identificationInfo/CHE_MD_DataIdentification", new Count(1,
                new Finder("descriptiveKeywords/MD_Keywords/thesaurusName/CI_Citation/title")));
    ...
    public void exportTopicCategoryToGM03() throws Throwable {
        ...
        rules.put("GM03_2_1Comprehensive.Comprehensive.MD_DataIdentification/topicCategory", new DoesNotExist(new Finder("GM03_2_1Core" +
                                                                                                                         ".Core" +
                                                                                                                         ".MD_TopicCategoryCode_/value", new EqualText("imageryBaseMapsEarthCover"))));
        rules.put("GM03_2_1Comprehensive.Comprehensive.MD_DataIdentification/topicCategory", new DoesNotExist(new Finder("GM03_2_1Core" +
                                                                                                                         ".Core" +
                                                                                                                         ".MD_TopicCategoryCode_/value", new EqualText("planningCadastre"))));
        rules.put("GM03_2_1Comprehensive.Comprehensive.MD_DataIdentification/topicCategory", new DoesNotExist(new Finder("GM03_2_1Core" +
                                                                                                                         ".Core" +
                                                                                                                         ".MD_TopicCategoryCode_/value", new EqualText("geoscientificInformation"))));
        rules.put("GM03_2_1Comprehensive.Comprehensive.MD_DataIdentification/topicCategory", new DoesNotExist(new Finder("GM03_2_1Core" +
                                                                                                                         ".Core" +
                                                                                                                         ".MD_TopicCategoryCode_/value", new EqualText("environment"))));
        rules.put("GM03_2_1Comprehensive.Comprehensive.MD_DataIdentification/topicCategory", new DoesNotExist(new Finder("GM03_2_1Core" +
                                                                                                                         ".Core" +
                                                                                                                         ".MD_TopicCategoryCode_/value", new EqualText("utilitiesCommunication"))));
        rules.put("GM03_2_1Comprehensive.Comprehensive.MD_DataIdentification/topicCategory", new Exists(new Finder("GM03_2_1Core.Core" +
                                                                                                                   ".MD_TopicCategoryCode_/value", new EqualText("planningCadastre.planningCadastre_Planning"))));
        rules.put("GM03_2_1Comprehensive.Comprehensive.MD_DataIdentification/topicCategory", new Exists(new Finder("GM03_2_1Core.Core" +
                                                                                                                   ".MD_TopicCategoryCode_/value", new EqualText("imageryBaseMapsEarthCover.imageryBaseMapsEarthCover_BaseMaps"))));
        rules.put("GM03_2_1Comprehensive.Comprehensive.MD_DataIdentification/topicCategory", new Exists(new Finder("GM03_2_1Core.Core" +
                                                                                                                   ".MD_TopicCategoryCode_/value", new EqualText("planningCadastre.planningCadastre_Planning"))));
        rules.put("GM03_2_1Comprehensive.Comprehensive.MD_DataIdentification/topicCategory", new Exists(new Finder("GM03_2_1Core.Core" +
                                                                                                                   ".MD_TopicCategoryCode_/value", new EqualText("geoscientificInformation.geoscientificInformation_Geology"))));
        rules.put("GM03_2_1Comprehensive.Comprehensive.MD_DataIdentification/topicCategory", new Exists(new Finder("GM03_2_1Core.Core" +
                                                                                                                   ".MD_TopicCategoryCode_/value", new EqualText("environment.environment_EnvironmentalProtection"))));
        rules.put("GM03_2_1Comprehensive.Comprehensive.MD_DataIdentification/topicCategory", new Exists(new Finder("GM03_2_1Core.Core" +
                                                                                                                   ".MD_TopicCategoryCode_/value", new EqualText("utilitiesCommunication.utilitiesCommunication_Energy"))));
        rules.put("GM03_2_1Comprehensive.Comprehensive.MD_DataIdentification/topicCategory", new Count(7,
                new Finder("GM03_2_1Core.Core.MD_TopicCategoryCode_/value")));
        file = testFile(file, Control.ISO_GM03, rules, false);

        rules.clear();
        rules.put("che:CHE_MD_DataIdentification/gmd:topicCategory", new Exists(new Finder("MD_TopicCategoryCode",
                new EqualText("planningCadastre_Planning"))));
        rules.put("che:CHE_MD_DataIdentification/gmd:topicCategory", new Exists(new Finder("MD_TopicCategoryCode",
                new EqualText("imageryBaseMapsEarthCover_BaseMaps"))));
        rules.put("che:CHE_MD_DataIdentification/gmd:topicCategory", new Exists(new Finder("MD_TopicCategoryCode",
                new EqualText("planningCadastre_Planning"))));
        rules.put("che:CHE_MD_DataIdentification/gmd:topicCategory", new Exists(new Finder("MD_TopicCategoryCode",
                new EqualText("geoscientificInformation_Geology"))));
        rules.put("che:CHE_MD_DataIdentification/gmd:topicCategory", new Exists(new Finder("MD_TopicCategoryCode",
                new EqualText("environment_EnvironmentalProtection"))));
        rules.put("che:CHE_MD_DataIdentification/gmd:topicCategory", new Exists(new Finder("MD_TopicCategoryCode",
                new EqualText("utilitiesCommunication_Energy"))));
    ...
    public void exportPurpose() throws Throwable {
        ...
        rules.put("che:CHE_MD_DataIdentification/purpose", new Exists(
                new Finder("LocalisedCharacterString", new And(new Exists(new Attribute("LocalisedCharacterString", "locale", "#DE")),
                        new EqualText("de geocat.ch II testen")))));
        rules.put("che:CHE_MD_DataIdentification/purpose", new Exists(
                new Finder("LocalisedCharacterString", new And(new Exists(new Attribute("LocalisedCharacterString", "locale", "#FR")),
                        new EqualText("fr geocat.ch II testen")))));
    ...
    public void serviceDoesNotHaveBasicGeoId() throws Throwable {
        ...
        rules.put("CHE_SV_ServiceIdentification", new Exists(new Finder("coupledResource/SV_CoupledResource/operationName",
                new Prefix("srv"))));
        ...
        rules.put("CHE_SV_ServiceIdentification", new Exists(new Finder("containsOperations/SV_OperationMetadata/operationName",
                new Prefix("srv"))));
        rules.put("CHE_SV_ServiceIdentification", new Exists(new Finder("containsOperations/SV_OperationMetadata/DCP",
                new Prefix("srv"))));
        rules.put("CHE_SV_ServiceIdentification", new Exists(new Finder("containsOperations/SV_OperationMetadata/connectPoint",
                new Prefix("srv"))));
    ...
    @Test
    @Ignore("I don't have time right now to get this to pass")
...
//        rules.put("GM03_2_1Comprehensive.Comprehensive.DQ_ElementmeasureIdentification", Requirement.ACCEPT);
        ...
        Requirement hasExpectedQuantitativeChildren =
                new And(new Exists(new Finder("gmd:valueType/gco:RecordType")),
                        ...
                        new Exists(new Finder("gmd:errorStatistic/CharacterString")),
                        // may need to be changed to PT_FreeText/textGroup/LocalisedCharacterString in future
...
//        rules.put("GM03_2_1Comprehensive.Comprehensive.DQ_ElementmeasureIdentification", Requirement.ACCEPT);
    ...
    private Multimap<String, Requirement> addMergeExtentsRules() {
        ...
        rules.put("identificationInfo", new Count(2, new Finder("EX_Extent/description/PT_FreeText/textGroup/LocalisedCharacterString",
                new StartsWithText("EX_11"))));
        rules.put("identificationInfo", new Count(2, new Finder("EX_Extent/description/PT_FreeText/textGroup/LocalisedCharacterString",
                new StartsWithText("EX_12"))));
    ...
    public void temporalExtent() throws Throwable {
        ...
        rules.put("EX_Extent/temporalElement/EX_TemporalExtent/extent/TimePeriod/begin/TimeInstant/timePosition",
                new EqualText("0200-01-01T00:00:00"));
        rules.put("EX_Extent/temporalElement/EX_TemporalExtent/extent/TimePeriod/end/TimeInstant/timePosition",
                new EqualText("2000-12-31T00:00:00"));
     ...
     * @param control         a contol explaining what transforms are required
     * @param validationRules the rules to test (node/node-segment to find, requirement
     *                        tests to run at that node)
     * @param testValidity
     * @return file after transform
     */
    private File testFile(File file, Control control, Multimap<String, Requirement> validationRules,
                          boolean testValidity) throws Throwable {
