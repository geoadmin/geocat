...
public class LocalXLinksSubstituedAtInsertTest extends AbstractServiceIntegrationTest {
    ...
    public void formatWithSpaces() throws Exception {
        expectedEx.expect(Exception.class);
        expectedEx.expectMessage("format-found no match for query: +_isTemplate:s^0.0 +_valid:1^0.0 __name:shapefile __version:\"grass version 6.1\"");
    ...
    public void insertMetadataCanReplaceExtentButMissContactAndFormat() throws Exception {
        ...
        expectedEx.expectMessage(
                "||format-found no match for query: +_isTemplate:s^0.0 +_valid:1^0.0 __name:shapefile __version:\"grass version 6.1\""+
    ...
    public void contactOrgWithSpacesNoMatch() throws Exception {
        expectedEx.expect(Exception.class);
        expectedEx.expectMessage("||contact-found no match for query: +_isTemplate:s^0.0 +_valid:1^0.0 _individualName:babar _orgName:\"generale d'electricite\" _email:info@csc.org");
        insertSubtemplate(FORMAT_RESOURCE);
        insertSubtemplate(EXTENT_RESOURCE);
