...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:variable name="itheme-topiccat-loc">
    <msg id="a" xml:lang="en">INSPIRE Themes and/or topic categories found with missing matching items. Run this
      suggestion to add all corresponding
      values.
    </msg>
    <msg id="a" xml:lang="fr">thèmes INSPIRE et/ou des catégories ont été trouvés avec des correspondances manquantes.
      Lancer ce processus pour ajouter les correspondances.
    </msg>
  </xsl:variable>
