...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template mode="MetaData" match="int:GM03_2_1Core.Core.MD_Metadata">
      <xsl:choose>
        ...
        <xsl:apply-templates mode="MetaData" select="int:GM03_2_1Core.Core.MD_Metadatacontact"/>
        ...
        <xsl:apply-templates mode="MetaData" select="int:GM03_2_1Comprehensive.Comprehensive.MD_GridSpatialRepresentation|
                                                     int:GM03_2_1Comprehensive.Comprehensive.MD_VectorSpatialRepresentation|
                                                     int:GM03_2_1Comprehensive.Comprehensive.MD_Georeferenceable|
                                                     int:GM03_2_1Comprehensive.Comprehensive.MD_Georectified"/>
        <xsl:apply-templates mode="MetaData" select="int:GM03_2_1Core.Core.referenceSystemInfoMD_Metadata"/>
        <xsl:apply-templates mode="MetaData" select="int:metadataExtensionInfo"/>
        <xsl:apply-templates mode="MetaData" select="int:GM03_2_1Comprehensive.Comprehensive.MD_DataIdentification|int:GM03_2_1Core.Core.MD_DataIdentification|int:GM03_2_1Comprehensive.Comprehensive.SV_ServiceIdentification"/>
        <xsl:apply-templates mode="MetaData" select="int:GM03_2_1Comprehensive.Comprehensive.MD_CoverageDescription|int:GM03_2_1Comprehensive.Comprehensive.MD_FeatureCatalogueDescription|int:GM03_2_1Comprehensive.Comprehensive.MD_RangeDimension|int:GM03_2_1Comprehensive.Comprehensive.MD_Band|int:GM03_2_1Comprehensive.Comprehensive.MD_ImageDescription"/>
        <xsl:apply-templates mode="MetaData" select="int:distributionInfo"/>
        <xsl:apply-templates mode="MetaData" select="int:GM03_2_1Core.Core.DQ_DataQuality"/>
        <xsl:apply-templates mode="MetaData" select="int:GM03_2_1Comprehensive.Comprehensive.portrayalCatalogueInfoMD_Metadata/int:portrayalCatalogueInfo"/>
        <xsl:apply-templates mode="MetaData" select="int:GM03_2_1Comprehensive.Comprehensive.MD_MetadatametadataConstraints/metadataConstraints"/>
        ...
        <xsl:apply-templates mode="MetaData" select="int:GM03_2_1Comprehensive.Comprehensive.MD_MaintenanceInformation"/>
        ...
        <xsl:apply-templates mode="MetaData" select="int:GM03_2_1Comprehensive.Comprehensive.MD_MetadatalegislationInformation"/>
    </xsl:template>
    ...
    <xsl:template mode="MetaData" match="int:GM03_2_1Comprehensive.Comprehensive.MD_PortrayalCatalogueReference">
    ...
    <xsl:template mode="MetaData" match="int:parentIdentifier">
        <gmd:parentIdentifier>
            <gco:CharacterString>
                <xsl:value-of select="int:GM03_2_1Core.Core.MD_Metadata/fileIdentifier"/>
            </gco:CharacterString>
        </gmd:parentIdentifier>
    </xsl:template>

    <xsl:template mode="MetaData" match="int:hierarchyLevel">
        <xsl:for-each select="int:GM03_2_1Core.Core.MD_ScopeCode_">
            <gmd:hierarchyLevel>
    ...
    <xsl:template mode="MetaData" match="int:GM03_2_1Core.Core.MD_Metadatacontact">
        <gmd:contact>
    ...
    <xsl:template mode="MetaData" match="int:GM03_2_1Comprehensive.Comprehensive.MD_MaintenanceInformation">
        <gmd:metadataMaintenance>
    ...
    <xsl:template mode="MetaData"
                  match="int:GM03_2_1Comprehensive.Comprehensive.MD_GridSpatialRepresentation|
                         int:GM03_2_1Comprehensive.Comprehensive.MD_VectorSpatialRepresentation|
                         int:GM03_2_1Comprehensive.Comprehensive.MD_Georeferenceable|
                         int:GM03_2_1Comprehensive.Comprehensive.MD_Georectified">
    ...
    <xsl:template mode="MetaData"
                  match="int:GM03_2_1Comprehensive.Comprehensive.MD_CoverageDescription|int:GM03_2_1Comprehensive.Comprehensive.MD_FeatureCatalogueDescription|int:GM03_2_1Comprehensive.Comprehensive.MD_RangeDimension|int:GM03_2_1Comprehensive.Comprehensive.MD_Band|int:GM03_2_1Comprehensive.Comprehensive.MD_ImageDescription">
        <gmd:contentInfo>
            <xsl:apply-templates select="." mode="Content"/>
        </gmd:contentInfo>
    </xsl:template>

    <xsl:template match="int:GM03_2_1Comprehensive.Comprehensive.MD_DataIdentification|int:GM03_2_1Core.Core.MD_DataIdentification|int:GM03_2_1Comprehensive.Comprehensive.SV_ServiceIdentification" mode="MetaData">
        <gmd:identificationInfo>
            <xsl:apply-templates select="." mode="DataIdentification"/>
        </gmd:identificationInfo>
    </xsl:template>
    <xsl:template match="int:GM03_2_1Comprehensive.Comprehensive.MD_MetadatalegislationInformation" mode="MetaData">
        <xsl:apply-templates mode="LegislationInfo"/>
    </xsl:template>

    <xsl:template match="int:GM03_2_1Core.Core.DQ_DataQuality" mode="MetaData">
        <xsl:apply-templates select="." mode="DataQuality"/>
    </xsl:template>

    <xsl:template match="int:GM03_2_1Core.Core.referenceSystemInfoMD_Metadata" mode="MetaData">
