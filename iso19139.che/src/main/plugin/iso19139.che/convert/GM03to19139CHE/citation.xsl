<xsl:stylesheet version="1.0"
    ...
    <xsl:template mode="Identifier" match="GM03Core.Core.MD_Identifier/code/GM03Core.Core.PT_FreeText/textGroup">
        <gmd:MD_Identifier>
            <gmd:code>
                <gco:CharacterString>
                    <xsl:value-of select="GM03Core.Core.PT_Group/plainText[1]"/>
                </gco:CharacterString>
            </gmd:code>
        </gmd:MD_Identifier>
    </xsl:template>
