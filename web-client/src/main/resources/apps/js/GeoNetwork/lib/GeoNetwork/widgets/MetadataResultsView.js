 ...
 */
/**
 * api: (define) module = GeoNetwork class = MetadataResultsView base_link =
 * `Ext.DataView <http://extjs.com/deploy/dev/docs/?class=Ext.DataView>`_
 */
/**
...
GeoNetwork.MetadataResultsView = Ext
        .extend(
                Ext.DataView,
                {
                    ...
                    /**
                     * api: config[map] Optional OpenLayers map or an array of
                     * Object with OpenLayers maps and zoomToExtentOnSearch
                     * property to be used for interacting with search results
                     * 
                     * Set zoomToExtentOnSearch to false, to not to zoom to
                     * features extent after result store update.
                     */
                    maps : [],

                    /**
                     * Projection MUST be the same for all maps linked to the
                     * metadata results view.
                     * 
                     */
                    ...
                    /**
                     * api: property[mdSelectionUuids] Current selection uuids
                     */
                    mdSelectionUuids : [],

                    /**
                     * api: property[layer_style_selected] Selected layer style.
                     * Unused
                     */
                    layer_style_selected : OpenLayers.Util.extend({},
                            OpenLayers.Feature.Vector.style['default']),

                    defaultConfig : {
                        /**
                         * api: property[featurecolor] Color for record's
                         * bounding box. By default #ee9900.
                         * 
                         * Example ::
                         * 
                         * metadataResultsView = new
                         * GeoNetwork.MetadataResultsView({ catalogue:
                         * catalogue, // Use a custom single color for bounding
                         * box featurecolor: '#FFFFFF'
                         */
                        featurecolor : '#ee9900',

                        /**
                         * api: property[colormap] Array of colors to be used
                         * for record's bounding box.
                         * 
                         * Example for configuration of feature color, color map
                         * or custom layer style::
                         * 
                         * metadataResultsView = new
                         * GeoNetwork.MetadataResultsView({ catalogue:
                         * catalogue, displaySerieMembers: true, autoScroll:
                         * true, tpl: GeoNetwork.Templates.FULL // Use a custom
                         * single color for bounding box , featurecolor:
                         * '#FFFFFF' // Use a random color map with 2 colors ,
                         * colormap: GeoNetwork.Util.generateColorMap(5) // Use
                         * a default color map with 10 colors , colormap:
                         * GeoNetwork.Util.defaultColorMap // Use a custom CSS
                         * rules , featurecolorCSS: "border-width:
                         * 5px;border-style: solid; border-color:
                         * ${featurecolor}" // Use a custom style , layer_style:
                         * new OpenLayers.Style({ strokeOpacity: 1, strokeWidth:
                         * 4, strokeColor: "${featurecolor}", fillColor:
                         * "${featurecolor}", fillOpacity: 0.2 }) ,
                         * layer_style_hover: new OpenLayers.Style({
                         * strokeOpacity: 1, strokeWidth: 10, strokeColor:
                         * "${featurecolor}", fillColor: "${featurecolor}",
                         * fillOpacity: 0 }) });
                         */
                        colormap : undefined,

                        /**
                         * api: property[layer_style] Layer style which could
                         * reference colormap colors. Example::
                         * 
                         * new OpenLayers.Style({ strokeOpacity: 1, strokeWidth:
                         * 1, strokeColor: "${color}", fillColor: "${color}",
                         * fillOpacity: 0 }),
                         */
                        ...
                        /**
                         * api: property[layer_style_hover] Hover layer style
                         * which could reference colormap colors.
                         */
                        layer_style_hover : new OpenLayers.Style({
                            strokeOpacity : 1,
                            strokeWidth : 3,
                    ...
                    /**
                     * api: property[features] Current features used by first
                     * maps
                     */
                    features : [],

                    /**
                     * api: property[features] Current hover feature for each
                     * maps
                     */
                    hover_feature : [],

                    /**
                     * api: config[displayContextualMenu] Display contextual
                     * menu for metadata record displayed on right click event
                     */
                    displayContextualMenu : true,
                    /**
                     * api: property[contextMenu] Context menu for metadata
                     * record displayed on right click event
                     */
                    contextMenu : undefined,

                    /**
                     * api: property[contextMenuNodeId] Identifier of the last
                     * node with context menu activated
                     */
                    contextMenuNodeId : undefined,

                    /**
                     * api: property[acMenu] Current action menu for onmouseover
                     * node
                     */
                    acMenu : undefined,

                    /**
                     * api: property[displaySerieMembers] Display metadata
                     * series member embedded in search results view as a list
                     * of items.
                     */
                    displaySerieMembers : false,

                    /**
                     * api: property[maxOfMembers] (TODO : UNUSED) Maximum
                     * numbers of members to display.
                     */
                    maxOfMembers : 50,

                    /**
                     * api: property[relatedTpl] Template use for related
                     * metadata if displaySerieMembers is true.
                     */
                    relatedTpl : undefined,

                    /**
                     * api: property[ratingWidget] Rating widget
                     */
                            ...
                            fn : function(dv, idx, node, e) {
                                ...
                                for (i = 0; i < this.maps.length; i++) {
                                    if (this.hover_feature[i]) {
                                        ...
                                        l.drawFeature(this.hover_feature[i],
                                                'default');
                    ...
                    actionMenuInit : function(idx, node) {
                        this.acMenu = Ext.get(Ext.DomQuery.selectNode(
                                'span.md-action-menu', node));
                        this.acMenu.on('click', function() {
                            this.createMenu(idx, this);
                            this.contextMenu.showAt([
                                    this.acMenu.getX(),
                                    this.acMenu.getY()
                                            + this.acMenu.getHeight() ]);
                        }, this);
                        this.acMenu.show();
                    },
                    ...
                    addMap : function(map, zoomToExtentOnSearch) {
                        ...
                        if (!found) {
                            ...
                            this.projectionFrom = new OpenLayers.Projection(
                                    "EPSG:4326");
                            this.projectionTo = new OpenLayers.Projection(
                                    this.mapsProjection);
                            this.maps.push(m);
                            this.initMap(m);
                        }
                    ...
                    /**
                     * private: method[initMap] :param map: An OpenLayers map
                     * :param idx: Index Add a Vector layer to the map
                     */
                    initMap : function(map) {
                        if (!this.styleInitialized) {
                            this.initStyle();
                            this.styleInitialized = true;
                            // TODO : a map may be initialized twice by 2
                            // differents results views
                        }

                        // TODO : Translate layer name based on a search name ?
                        var l = new OpenLayers.Layer.Vector(OpenLayers
                                .i18n("mdResultsLayer"), {
                            styleMap : new OpenLayers.StyleMap({
                                'default' : this.layer_style,
                                'hover' : this.layer_style_hover
                            })
                        });
                    ...
                    /**
                     * api: method[removeMap] :param mapId:
                     * ``OpenLayers.Map.id`` An OpenLayers map id
                     * 
                     * 
                     */
                    ...
                    /**
                     * api: method[getTemplates] Return templates
                     */
                    getTemplates : function() {
                        return this.templates;
                    },
                    /**
                     * api: method[removeTemplate] :param name: ``String``
                     * template key
                     * 
                     * Remove a template
                     */
                    ...
                    /**
                     * api: method[getTemplates] :param name: ``String`` The
                     * template key :param template: ``XTempalte`` The template
                     * 
                     * Add templates
                     */
                    ...
                    /**
                     * api: method[applyTemplate] :param name: ``String``
                     * template key
                     * 
                     * Apply one templates
                     */
                    ...
                    /**
                     * private: method[initStyle] Define default layer styles
                     */
                    initStyle : function() {
                        ...
                        if (this.colormap.length > 1) {
                            this.featurecolorCSS = this.featurecolorCSS
                                    || "border-left-width: 3px;border-left-style: solid; border-left-color: ${featurecolor}";
                        } else {
                                ...
                                .each(
                                        ...
                                        function(r) {
                                            ...
                                            if (links.length > 0) {
                                                var div = Ext.query(
                                                        '#md-links-' + id,
                                                        view.el.dom.body), el = Ext
                                                        .get(div[0]);

                                                // The template may not defined
                                                // a md-links placeholder
                                                if (el) {
                                                    ...
                                                    var linkButton = [], kmlButton = [], label = null, currentType = null, bt, allowDynamic = r
                                                            .get('dynamic'), allowDownload = r
                                                            .get('download'), hasDownloadAction = false;

                                                    // Swisstopo custom: Display
                                                    // links if available in
                                                    // results, don't check
                                                    // dynamic info
                                                    allowDynamic = true;
                    ...
                    /**
                     * private: method[addLinkMenu] Display a menu with links
                     * for a metadata record for a protocol. If there is only
                     * one element in the linkButton array, display a menu and
                     * display a dropdown menu if not.
                     */
                    ...
                    /**
                     * private: method[dislayRelations] Search for children for
                     * all records which are series. All members are displayed
                     * in a UL element identified by
                     * "md-relation-{metadata_id}".
                     * 
                     * If the div has a max-height attribute and scrolling is
                     * required, a "more" class is added to the element. This
                     * class could be used to do custom styling of the div (eg.
                     * expand to display all members).
                     * 
                        ...
                        if (this.displaySerieMembers) {
                            Ext
                                    .each(
                                            records,
                                            function(r) {
                                                var isSerie = GeoNetwork.Settings.results.loadRelationForAll
                                                        || r.get('type') === 'series', id = r
                                                        .get('id');
                                                if (isSerie) {
                                                    // TODO : use
                                                    // this.maxOfMembers
                                                    // var store = new
                                                    // GeoNetwork.data.MetadataResultsFastStore();
                                                    var store = new GeoNetwork.data.MetadataRelationStore(
                                                            this.catalogue.services.mdRelation
                                                                    + '?type='
                                                                    + relationTypes
                                                                    + '&fast=false&uuid='
                                                                    + escape(r
                                ...
                                .each(
                                        ...
                                        function(r, idx) {
                                            ...
                                            r
                                                    .set(
                                                            'featurecolorCSS',
                                                            this.featurecolorCSS ? OpenLayers.String
                                                                    .format(
                                            ...
                                            if (bboxes) {
                                                ...
                                                for (j = 0; j < bboxes.length; j++) {
                                                    ...
                                                    var p3 = new OpenLayers.Geometry.Point(
                                                            bbox[0], bbox[3]);
                                                    var p4 = new OpenLayers.Geometry.Point(
                                                            bbox[0], bbox[1]);
                                                ...
                                                this.features.push(multipolygon
                                                        .clone());
                                            }
                                        }, this);
                    ...
                    /**
                     * private: method[initRatingWidget] After a search,
                     * retrieve rating div and init readonly widget.
                     */
                    ...
                    selectAllInPage : function() {
                        ...
                        for (idx = 0; idx < checkboxes.length; ++idx) {
                            checkboxes[idx].checked = true;
                            Ext.each(this.getRecords(this.getNodes()),
                                    function(r) {
                                        var uuid = r.get('uuid');
                                        this.catalogue.metadataSelect('add',
                                                [ uuid ]);
                                    }, this);
                    ...
                    /**
                     * private: method[addCurrentFeatures] Add current features,
                     * Clone feature before adding them to the maps And keep on
                     * set of feature if all maps are unregistered
                     */
                    ...
                    /**
                     * private: method[onDestroy] Private method called during
