...
class SaveServiceTestImpl extends Save {
    ...
    public SaveServiceTestImpl(Element testMetadata) throws IOException, JDOMException {
        ...
        sharedObjects.put("local://xml.extent.get?id=2&amp;wfs=default&amp;typename=gn:kantoneBB&amp;format=gmd_complete&amp;" +
                          "extentTypeCode=true", bernExtent);
        Element fribourgExtent = createExtent("Fribourg", "Fribourg");
        sharedObjects.put("local://xml.extent.get?id=2196&amp;wfs=default&amp;typename=gn:gemeindenBB&amp;format=gmd_complete&amp;" +
                          "extentTypeCode=true", fribourgExtent);
    }
    ...
    Element createContact(String name, String lastName, String email, String role, Pair<String,
        ...
        builder.append("        </gmd:PT_FreeText>\n").
                ...
                append("              <gmd:electronicMailAddress><gco:CharacterString>").append(email).append
