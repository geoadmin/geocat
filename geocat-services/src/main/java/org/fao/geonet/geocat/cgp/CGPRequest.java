...
public class CGPRequest extends SOAPRequest {
    ...
    public static final Namespace NAMESPACE_GM03COMPREHENSIVE = Namespace.getNamespace("gm03c",
            "http://www.geocat.ch/2003/05/gateway/GM03Comprehensive");
    ...
    public List<Element> query(CGPQueryCriteria criteria) throws SOAPFaultEx, JDOMException, IOException, BadXmlResponseEx,
            BadSoapResponseEx, URISyntaxException {
