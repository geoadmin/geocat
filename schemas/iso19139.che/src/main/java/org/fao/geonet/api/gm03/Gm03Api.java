...
public class Gm03Api  {
    ...
    @ApiOperation(value = "Get a metadata record as full GM03",
            notes = "",
            nickname = "getRecordAsGM03")
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Return the record in GM03 format."),
            @ApiResponse(code = 403, message = ApiParams.API_RESPONSE_NOT_ALLOWED_CAN_VIEW)
    })
    public
    @ResponseBody
    Element getRecordAsXML(
            @ApiParam(
