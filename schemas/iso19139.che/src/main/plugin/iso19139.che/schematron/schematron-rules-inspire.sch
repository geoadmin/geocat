...
-->
    ...
    <sch:pattern>
        ...
        <sch:rule context="//gmd:distributionInfo/*/gmd:transferOptions/*/gmd:onLine/gmd:CI_OnlineResource">
            ...
            <sch:let name="noResourceLocator" value="normalize-space($linkageText)=''"/>
    ...
    <sch:pattern>
        ...
        <sch:rule context="//gmd:MD_DataIdentification[
			                    ../../gmd:hierarchyLevel/gmd:MD_ScopeCode/@codeListValue/normalize-space(.) = 'series' or
			                    ../../gmd:hierarchyLevel/gmd:MD_ScopeCode/@codeListValue/normalize-space(.) = 'dataset' or
			                    ../../gmd:hierarchyLevel/gmd:MD_ScopeCode/@codeListValue/normalize-space(.) = '']|
            ...
            <sch:let name="noTopic" value="gmd:topicCategory/gmd:MD_TopicCategoryCode/normalize-space(text()) = ''"/>
