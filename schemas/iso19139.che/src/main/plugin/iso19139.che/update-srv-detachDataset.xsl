...
>
  ...
  <!-- Detach -->
  <xsl:template match="srv:operatesOn[@uuidref=$uuid]" priority="2"/>
  <xsl:template match="srv:coupledResource[srv:SV_CoupledResource/srv:identifier/gco:CharacterString=$uuid]"
                priority="2"/>
