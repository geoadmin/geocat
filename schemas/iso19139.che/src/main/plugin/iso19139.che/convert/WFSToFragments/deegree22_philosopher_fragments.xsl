          ...
          <gmd:geographicElement>
            <gmd:EX_GeographicBoundingBox>
              <gmd:westBoundLongitude>
                <gco:Decimal>
                  <xsl:value-of select="substring-before(gml:boundedBy/gml:Envelope/gml:pos[1],' ')"/>
                </gco:Decimal>
              </gmd:westBoundLongitude>
              <gmd:eastBoundLongitude>
                <gco:Decimal>
                  <xsl:value-of select="substring-after(gml:boundedBy/gml:Envelope/gml:pos[1],' ')"/>
                </gco:Decimal>
              </gmd:eastBoundLongitude>
              <gmd:southBoundLatitude>
                <gco:Decimal>
                  <xsl:value-of select="substring-before(gml:boundedBy/gml:Envelope/gml:pos[2],' ')"/>
                </gco:Decimal>
              </gmd:southBoundLatitude>
              <gmd:northBoundLatitude>
                <gco:Decimal>
                  <xsl:value-of select="substring-after(gml:boundedBy/gml:Envelope/gml:pos[2],' ')"/>
                </gco:Decimal>
              </gmd:northBoundLatitude>
            </gmd:EX_GeographicBoundingBox>
          </gmd:geographicElement>
      ...
      <fragment id="contactinfo" uuid="{@gml:id}_contactinfo" title="{concat(app:name,':',app:id,':contactinfo')}">
        <gmd:CI_ResponsibleParty>
          ...
          <gmd:organisationName>
            <gco:CharacterString>Silicon Graphics R4400 64bit Systems and Philosophy Management Section
            </gco:CharacterString>
          </gmd:organisationName>
          <gmd:positionName>
