...
<xsl:stylesheet version="2.0"
    ...
    <xsl:template mode="Extent" match="int:GM03_2_1Core.Core.EX_Extent">
        <xsl:choose>
            <xsl:when test="int:GM03_2_1Core.Core.EX_ExtentgeographicElement[.//int:GM03_2_1Core.Core.EX_BoundingPolygon]">
                <gmd:extent>
                    <gmd:EX_Extent>
                       <xsl:apply-templates mode="Extent" select="int:description"/>

                        <xsl:variable name="polygon">
                            <xsl:if test="int:GM03_2_1Core.Core.EX_ExtentgeographicElement[.//int:GM03_2_1Core.Core.EX_BoundingPolygon]">
                                <xsl:apply-templates mode="Extent" select="int:GM03_2_1Core.Core.EX_ExtentgeographicElement[.//int:GM03_2_1Core.Core.EX_BoundingPolygon]"/>
                            </xsl:if>
                        </xsl:variable>
                        ...
                        <xsl:apply-templates mode="Extent" select="int:GM03_2_1Core.Core.EX_ExtentgeographicElement[not(.//int:GM03_2_1Core.Core.EX_BoundingPolygon or .//int:GM03_2_1Core.Core.EX_GeographicBoundingBox)]"/>
                    </gmd:EX_Extent>
                </gmd:extent>
            </xsl:when>
            <xsl:when test="int:GM03_2_1Core.Core.EX_ExtentgeographicElement[.//int:GM03_2_1Core.Core.EX_GeographicBoundingBox]">
                <xsl:for-each select="int:GM03_2_1Core.Core.EX_ExtentgeographicElement//int:GM03_2_1Core.Core.EX_GeographicBoundingBox">
                    <gmd:extent>
                        <gmd:EX_Extent>
                            <xsl:apply-templates mode="Extent" select="ancestor::int:GM03_2_1Core.Core.EX_Extent/int:description"/>
                             <gmd:geographicElement>
        ...
        <xsl:for-each select=".//int:GM03_2_1Core.Core.EX_ExtenttemporalElement[not(temporalElement/int:GM03_2_1Core.Core.EX_SpatialTemporalExtent)]">
           <gmd:extent>
               <gmd:EX_Extent>
        ...
        <xsl:if test=".//int:GM03_2_1Core.Core.EX_ExtenttemporalElement[temporalElement/int:GM03_2_1Core.Core.EX_SpatialTemporalExtent]">
           <xsl:comment>TODO int:GM03_2_1Core.Core.EX_ExtenttemporalElement without TM_Primitive</xsl:comment>
           <!-- Remove the not(temporalElement/int:GM03_2_1Core.Core.EX_SpatialTemporalExtent) from previous for-each and fix the spatial temporal.
           It seems to be that XslUtil mutlipolygon and bbox expect the normal extent and cannot handle spatialExtent -->
        </xsl:if>
        <xsl:for-each select=".//int:GM03_2_1Core.Core.EX_VerticalExtent">
           <gmd:extent>
               <gmd:EX_Extent>
    ...
    <xsl:template mode="Extent" match="int:geographicElement[not(int:GM03_2_1Core.Core.EX_GeographicBoundingBox|int:GM03_2_1Core.Core.EX_BoundingPolygon)]">
        <gmd:geographicElement>
            <xsl:apply-templates mode="Extent"/>
        </gmd:geographicElement>
    </xsl:template>

    <xsl:template mode="Extent" match="int:geographicElement[int:GM03_2_1Core.Core.EX_BoundingPolygon]">
        <xsl:for-each select="int:GM03_2_1Core.Core.EX_BoundingPolygon">
            <gmd:geographicElement>
                <xsl:apply-templates mode="Extent" select="."/>
            </gmd:geographicElement>
        </xsl:for-each>
    ...
    <xsl:template mode="Extent" match="int:geographicElement[int:GM03_2_1Core.Core.EX_GeographicBoundingBox]">
        <xsl:choose>
            <xsl:when test="ancestor::int:GM03_2_1Core.Core.EX_Extent//int:GM03_2_1Core.Core.EX_BoundingPolygon">
                <xsl:comment>
            ...
            <xsl:otherwise>
                <gmd:geographicElement>
                    <xsl:apply-templates mode="Extent" select="int:GM03_2_1Core.Core.EX_GeographicBoundingBox"/>
                </gmd:geographicElement>
            </xsl:otherwise>
        </xsl:choose>
    </xsl:template>

    <xsl:template mode="Extent" match="int:GM03_2_1Core.Core.EX_GeographicDescription">
    ...
    <xsl:template mode="Extent" match="int:GM03_2_1Core.Core.EX_BoundingPolygon">
        <gmd:EX_BoundingPolygon>
            <xsl:apply-templates mode="BoundingPoly"/>
        </gmd:EX_BoundingPolygon>
    </xsl:template>

    <xsl:template mode="Extent" match="int:GM03_2_1Core.Core.EX_GeographicBoundingBox[not(ancestor::int:GM03_2_1Core.Core.EX_Extent//int:GM03_2_1Core.Core.EX_BoundingPolygon)]">
    ...
    <xsl:template mode="Temporal" match="int:GM03_2_1Core.Core.EX_ExtenttemporalElement/int:temporalElement">
        <gmd:temporalElement>
                <xsl:apply-templates mode="Temporal"/>
        </gmd:temporalElement>
    </xsl:template>

    <xsl:template mode="Temporal" match="int:GM03_2_1Core.Core.EX_TemporalExtent">
    ...
    <xsl:template mode="Temporal" match="int:GM03_2_1Core.Core.EX_SpatialTemporalExtent">
        ...
        <!-- <gmd:EX_SpatialTemporalExtent>
          <gmd:extent>
            ...
            <xsl:apply-templates mode="Temporal" select="int:GM03_2_1Core.Core.spatialExtentEX_SpatialTemporalExtent"/>
        </gmd:EX_SpatialTemporalExtent> -->
    </xsl:template>

  <xsl:template mode="TemporalExtent"
    match="int:GM03_2_1Core.Core.spatialExtentEX_SpatialTemporalExtent">
        <xsl:comment>Need to implement spatialExtent import</xsl:comment>
    <xsl:choose>
      <xsl:when test="int:spatialExtent[.//int:GM03_2_1Core.Core.EX_BoundingPolygon]">
        <gmd:spatialExtent>
          <xsl:comment>
            spatialExtent[.//int:GM03_2_1Core.Core.EX_BoundingPolygon]
          </xsl:comment>
          <xsl:apply-templates mode="Extent" select="int:description" />

          <xsl:variable name="polygon">
            <xsl:if test="int:spatialExtent[.//int:GM03_2_1Core.Core.EX_BoundingPolygon]">
              <xsl:apply-templates mode="Extent"
                select="int:spatialExtent[.//int:GM03_2_1Core.Core.EX_BoundingPolygon]" />
            </xsl:if>
          </xsl:variable>
          <xsl:if test="normalize-space($polygon) != ''">
              <xsl:copy-of select="cheutil:multipolygon(string(int:description), $polygon)" />
          ...
          <xsl:apply-templates mode="Extent"
            select="int:spatialExtent[not(.//int:GM03_2_1Core.Core.EX_BoundingPolygon or .//int:GM03_2_1Core.Core.EX_GeographicBoundingBox)]" />
        </gmd:spatialExtent>
      </xsl:when>
      <xsl:when test="int:spatialExtent[.//int:GM03_2_1Core.Core.EX_GeographicBoundingBox]">
        <xsl:for-each
          select="int:spatialExtent//int:GM03_2_1Core.Core.EX_GeographicBoundingBox">
          <gmd:spatialExtent>
            <xsl:comment>
              spatialExtent//int:GM03_2_1Core.Core.EX_GeographicBoundingBox
            </xsl:comment>
            <xsl:apply-templates mode="Extent"
              select="ancestor::int:GM03_2_1Core.Core.EX_Extent/int:description" />
            <gmd:geographicElement>
              <xsl:apply-templates mode="Extent" select="." />
            </gmd:geographicElement>
            <xsl:apply-templates mode="Extent"
              select="int:GM03_2_1Core.Core.EX_ExtentgeographicElement[not(.//int:GM03_2_1Core.Core.EX_BoundingPolygon or .//int:GM03_2_1Core.Core.EX_GeographicBoundingBox)]|spatialExtent[not(.//int:GM03_2_1Core.Core.EX_BoundingPolygon or .//int:GM03_2_1Core.Core.EX_GeographicBoundingBox)]" />
          </gmd:spatialExtent>
        </xsl:for-each>
      </xsl:when>
      <xsl:otherwise>
    ...
    <xsl:for-each select=".//int:GM03_2_1Core.Core.EX_ExtenttemporalElement">
      <gmd:spatialExtent>
        <xsl:comment>
          .//int:GM03_2_1Core.Core.EX_ExtenttemporalElement
        </xsl:comment>
        <xsl:apply-templates mode="Temporal" />
      </gmd:spatialExtent>
    </xsl:for-each>
    <xsl:for-each select=".//int:GM03_2_1Core.Core.EX_VerticalExtent">
      <gmd:spatialExtent>
        <xsl:comment>
          .//int:GM03_2_1Core.Core.EX_VerticalExtent
        </xsl:comment>
        <xsl:apply-templates mode="Extent" />
      </gmd:spatialExtent>
    </xsl:for-each>
    ...
    <xsl:template mode="Temporal" match="int:GM03_2_1Core.Core.spatialExtentEX_SpatialTemporalExtent">
    ...
    <xsl:template match="int:GM03_2_1Core.Core.GM_Point_" mode="GM_Object">
    ...
    <!-- ================================================================================= -->
    <xsl:template mode="BboxToPolygon" match="int:GM03_2_1Core.Core.EX_GeographicBoundingBox">
