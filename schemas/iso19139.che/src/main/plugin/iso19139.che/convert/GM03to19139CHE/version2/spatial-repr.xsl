...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="int:GM03_2Comprehensive.Comprehensive.MD_VectorSpatialRepresentation" mode="SpatialRepr">
    ...
    <xsl:template match="int:GM03_2Comprehensive.Comprehensive.MD_GridSpatialRepresentation" mode="SpatialRepr">
    ...
    <xsl:template match="int:GM03_2Comprehensive.Comprehensive.MD_Dimension" mode="SpatialRepr">
    ...
    <!-- ================================================================================= -->
    <xsl:template match="int:GM03_2Comprehensive.Comprehensive.MD_Georeferenceable" mode="SpatialRepr">
    ...
    <!-- ================================================================================= -->
    <xsl:template match="int:GM03_2Comprehensive.Comprehensive.MD_Georectified" mode="SpatialRepr">
        <gmd:MD_Georectified>
    <!-- gridSpatial properties -->
            <xsl:apply-templates mode="SpatialRepr" select="int:numberOfDimensions"/>
            <xsl:apply-templates mode="SpatialRepr" select="int:GM03_2Comprehensive.Comprehensive.MD_Dimension"/>
    ...
    <xsl:template match="int:cornerPoints" mode="SpatialRepr">
        <xsl:for-each select="int:GM03_2Core.Core.GM_Point_">
            <gmd:cornerPoints>
    ...
    <xsl:template match="int:GM03_2Comprehensive.Comprehensive.MD_Dimension" mode="Dimension">
        <gmd:MD_Dimension>
    ...
    <xsl:template match="int:GM03_2Comprehensive.Comprehensive.MD_GeometricObjects" mode="SpatialRepr">
