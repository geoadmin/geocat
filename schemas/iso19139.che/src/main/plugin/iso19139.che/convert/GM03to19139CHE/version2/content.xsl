...
<xsl:stylesheet version="2.0"
    ...
    <xsl:template mode="Content"
        ...
        <che:CHE_MD_CoverageDescription>
            ...
            <xsl:apply-templates mode="Content" select="int:GM03_2Comprehensive.Comprehensive.dimensionMD_CoverageDescription"/>
    ...
    <xsl:template mode="Content" match="int:GM03_2Comprehensive.Comprehensive.dimensionMD_CoverageDescription">
    ...
    <xsl:template mode="Content" match="int:GM03_2Comprehensive.Comprehensive.MD_Band">
        <gmd:MD_Band>
    ...
    <xsl:template mode="Content" match="int:GM03_2Comprehensive.Comprehensive.MD_ImageDescription">
    ...
    <xsl:template mode="Content" match="int:GM03_2Comprehensive.Comprehensive.MD_RangeDimension">
    ...
    <xsl:template mode="Content"
                  match="int:GM03_2Comprehensive.Comprehensive.MD_FeatureCatalogueDescription">
        <che:CHE_MD_FeatureCatalogueDescription gco:isoType="gmd:MD_FeatureCatalogueDescription">
            ...
            <xsl:for-each select="int:featureTypes">
                <xsl:for-each select="int:GM03_2Comprehensive.Comprehensive.GenericName_/int:value">
                    <gmd:featureTypes>
            ...
            <xsl:if test="not(int:GM03_2Comprehensive.Comprehensive.CI_Citation)">
                <gmd:featureCatalogueCitation/>
            </xsl:if>
            ...
            <xsl:for-each select="int:dataModel">
                <che:dataModel xsi:type="che:PT_FreeURL_PropertyType">
                    <xsl:choose>
                        <xsl:when test="int:GM03_2Core.Core.PT_FreeURL">
                            <xsl:apply-templates mode="language" select="int:GM03_2Core.Core.PT_FreeURL"/>
                        </xsl:when>
                        <xsl:otherwise>
            ...
            <xsl:apply-templates mode="Content" select="int:GM03_2Comprehensive.Comprehensive.classMD_FeatureCatalogueDescription"/>
            <xsl:apply-templates mode="Content" select="int:GM03_2Comprehensive.Comprehensive.domainMD_FeatureCatalogueDescription"/>
            <xsl:choose>
            ...
            <xsl:apply-templates mode="Content" select="int:GM03_2_2Comprehensive.Comprehensive.CI_Citation"/>
        </che:CHE_MD_FeatureCatalogueDescription>
    </xsl:template>

    <xsl:template mode="Content" match="int:GM03_2Comprehensive.Comprehensive.domainMD_FeatureCatalogueDescription">
        <xsl:apply-templates mode="Content"/>
    </xsl:template>
    ...
    <xsl:template mode="Content" match="int:GM03_2Comprehensive.Comprehensive.MD_CodeDomain">
    ...
    <xsl:template mode="Content" match="int:GM03_2Comprehensive.Comprehensive.MD_Type">
        <!--<che:CHE_MD_Type>-->
            <xsl:apply-templates mode="textCHE" select="int:type"/>
            <xsl:for-each select="int:GM03_2Comprehensive.Comprehensive.MD_CodeValue">
                <che:value>
    ...
    <xsl:template mode="Content" match="int:GM03_2Comprehensive.Comprehensive.MD_CodeValue">
    ...
    <xsl:template mode="Content" match="int:GM03_2Comprehensive.Comprehensive.classMD_FeatureCatalogueDescription">
        <xsl:apply-templates mode="Content"/>
    </xsl:template>
    ...
    <xsl:template mode="Content" match="int:GM03_2Comprehensive.Comprehensive.MD_Class">
        <che:CHE_MD_Class>
            <xsl:apply-templates mode="textCHE" select="int:name"/>
            <che:description>
                <xsl:apply-templates mode="language" select="int:description/*"/>
            </che:description>
            <xsl:apply-templates mode="Content" select="int:GM03_2Comprehensive.Comprehensive.MD_Attribute"/>
            <xsl:apply-templates mode="Content" select=".//baseClass"/>   <!-- TODO -->
            <xsl:apply-templates mode="Content" select=".//subClass"/>   <!-- TODO -->
        </che:CHE_MD_Class>
    </xsl:template>

    <xsl:template mode="Content" match="int:GM03_2Comprehensive.Comprehensive.MD_Attribute">
        <che:attribute>
            <xsl:apply-templates mode="textCHE" select="int:name"/>
            <xsl:apply-templates mode="textCHE" select="int:description"/>
            <che:namedType>
                <xsl:apply-templates mode="Content" select="int:GM03_2Comprehensive.Comprehensive.MD_AttributenamedType"/>
            </che:namedType>
            <xsl:apply-templates mode="Content" select="int:anonymousType"/>
        </che:attribute>
    </xsl:template>

    <xsl:template mode="Content" match="int:GM03_2Comprehensive.Comprehensive.MD_AttributenamedType">
            <xsl:apply-templates mode="Content" select="int:namedType/int:GM03_2Comprehensive.Comprehensive.MD_CodeDomain"/>
    </xsl:template>

    <xsl:template mode="Content" match="int:anonymousType">
        <che:anonymousType>
            <che:CHE_MD_Type>
                <xsl:apply-templates mode="textCHE" select="int:GM03_2Comprehensive.Comprehensive.MD_Type/int:type"/>
                <che:value>
                    <xsl:apply-templates mode="Content" select="int:GM03_2Comprehensive.Comprehensive.MD_Type/int:GM03_2Comprehensive.Comprehensive.MD_CodeValue"/>
                </che:value>
            </che:CHE_MD_Type>
        </che:anonymousType>
    </xsl:template>
