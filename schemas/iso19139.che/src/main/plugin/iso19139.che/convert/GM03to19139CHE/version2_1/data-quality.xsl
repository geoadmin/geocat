...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="int:GM03_2_1Core.Core.DQ_DataQuality" mode="DataQuality">
    <!--  if DataQuality is empty then don't add it as it makes the document invalid -->
        <xsl:if test="count(./node())>0">
            <gmd:dataQualityInfo>
                <gmd:DQ_DataQuality>
                    <xsl:apply-templates mode="DataQuality" select="int:GM03_2_1Comprehensive.Comprehensive.DQ_Scope|int:GM03_2_1Core.Core.DQ_Scope"/>
                    <xsl:apply-templates mode="DataQuality" select="int:GM03_2_1Comprehensive.Comprehensive.reportDQ_DataQuality"/>
                    <xsl:apply-templates mode="DataQuality" select="int:GM03_2_1Core.Core.LI_Lineage"/>
                </gmd:DQ_DataQuality>
            </gmd:dataQualityInfo>
        </xsl:if>
    </xsl:template>

    <xsl:template mode="DataQuality" match="int:GM03_2_1Comprehensive.Comprehensive.reportDQ_DataQuality">
    ...
    <xsl:template mode="DataQuality" match="int:GM03_2_1Comprehensive.Comprehensive.DQ_TemporalValidity">
        <xsl:apply-templates mode="DQ_Element" select=".">
            <xsl:with-param name="reportName">DQ_TemporalValidity</xsl:with-param>
        </xsl:apply-templates>
    </xsl:template>

    <xsl:template mode="DataQuality" match="int:GM03_2_1Comprehensive.Comprehensive.DQ_TemporalConsistency">
        <xsl:apply-templates mode="DQ_Element" select=".">
            <xsl:with-param name="reportName">DQ_TemporalConsistency</xsl:with-param>
        </xsl:apply-templates>
    </xsl:template>

    <xsl:template mode="DataQuality" match="int:GM03_2_1Comprehensive.Comprehensive.DQ_AccuracyOfATimeMeasurement">
        <xsl:apply-templates mode="DQ_Element" select=".">
            <xsl:with-param name="reportName">DQ_AccuracyOfATimeMeasurement</xsl:with-param>
        </xsl:apply-templates>
    </xsl:template>

    <xsl:template mode="DataQuality" match="int:GM03_2_1Comprehensive.Comprehensive.DQ_QuantitativeAttributeAccuracy">
        <xsl:apply-templates mode="DQ_Element" select=".">
            <xsl:with-param name="reportName">DQ_QuantitativeAttributeAccuracy</xsl:with-param>
        </xsl:apply-templates>
    </xsl:template>

    <xsl:template mode="DataQuality" match="int:GM03_2_1Comprehensive.Comprehensive.DQ_NonQuantitativeAttributeAccuracy">
        <xsl:apply-templates mode="DQ_Element" select=".">
            <xsl:with-param name="reportName">DQ_NonQuantitativeAttributeAccuracy</xsl:with-param>
        </xsl:apply-templates>
    </xsl:template>

    <xsl:template mode="DataQuality" match="int:GM03_2_1Comprehensive.Comprehensive.DQ_ThematicClassificationCorrectness">
        <xsl:apply-templates mode="DQ_Element" select=".">
            <xsl:with-param name="reportName">DQ_ThematicClassificationCorrectness</xsl:with-param>
        </xsl:apply-templates>
    </xsl:template>

    <xsl:template mode="DataQuality" match="int:GM03_2_1Comprehensive.Comprehensive.DQ_RelativeInternalPositionalAccuracy">
        <xsl:apply-templates mode="DQ_Element" select=".">
            <xsl:with-param name="reportName">DQ_RelativeInternalPositionalAccuracy</xsl:with-param>
        </xsl:apply-templates>
    </xsl:template>

    <xsl:template mode="DataQuality" match="int:GM03_2_1Comprehensive.Comprehensive.DQ_GriddedDataPositionalAccuracy">
        <xsl:apply-templates mode="DQ_Element" select=".">
            <xsl:with-param name="reportName">DQ_GriddedDataPositionalAccuracy</xsl:with-param>
        </xsl:apply-templates>
    </xsl:template>

    <xsl:template mode="DataQuality" match="int:GM03_2_1Comprehensive.Comprehensive.DQ_AbsoluteExternalPositionalAccuracy">
        <xsl:apply-templates mode="DQ_Element" select=".">
            <xsl:with-param name="reportName">DQ_AbsoluteExternalPositionalAccuracy</xsl:with-param>
        </xsl:apply-templates>
    </xsl:template>

    <xsl:template mode="DataQuality" match="int:GM03_2_1Comprehensive.Comprehensive.DQ_TopologicalConsistency">
        <xsl:apply-templates mode="DQ_Element" select=".">
            <xsl:with-param name="reportName">DQ_TopologicalConsistency</xsl:with-param>
        </xsl:apply-templates>
    </xsl:template>

    <xsl:template mode="DataQuality" match="int:GM03_2_1Comprehensive.Comprehensive.DQ_FormatConsistency">
        <xsl:apply-templates mode="DQ_Element" select=".">
            <xsl:with-param name="reportName">DQ_FormatConsistency</xsl:with-param>
        </xsl:apply-templates>
    </xsl:template>

    <xsl:template mode="DataQuality" match="int:GM03_2_1Comprehensive.Comprehensive.DQ_DomainConsistency">
        <xsl:apply-templates mode="DQ_Element" select=".">
            <xsl:with-param name="reportName">DQ_DomainConsistency</xsl:with-param>
        </xsl:apply-templates>
    </xsl:template>

    <xsl:template mode="DataQuality" match="int:GM03_2_1Comprehensive.Comprehensive.DQ_ConceptualConsistency">
        <xsl:apply-templates mode="DQ_Element" select=".">
            <xsl:with-param name="reportName">DQ_ConceptualConsistency</xsl:with-param>
        </xsl:apply-templates>
    </xsl:template>

    <xsl:template mode="DataQuality" match="int:GM03_2_1Comprehensive.Comprehensive.DQ_CompletenessOmission">
        <xsl:apply-templates mode="DQ_Element" select=".">
            <xsl:with-param name="reportName">DQ_CompletenessOmission</xsl:with-param>
        </xsl:apply-templates>
    </xsl:template>

    <xsl:template mode="DataQuality" match="int:GM03_2_1Comprehensive.Comprehensive.DQ_CompletenessCommission">
        <xsl:apply-templates mode="DQ_Element" select=".">
    ...
    <xsl:template mode="DQ_Element" match="*">
        ...
        <gmd:report>
            <xsl:element name="gmd:{string($reportName)}"
                ...
                <xsl:apply-templates mode="DataQualityReport" select="int:GM03_2_1Comprehensive.Comprehensive.DQ_ConformanceResult"/>
                <xsl:apply-templates mode="DataQualityReport" select="int:GM03_2_1Comprehensive.Comprehensive.DQ_QuantitativeResult"/>
            </xsl:element>
        </gmd:report>
    </xsl:template>
    ...
    <xsl:template mode="DataQualityReport" match="int:GM03_2_1Comprehensive.Comprehensive.DQ_ConformanceResult">
        <gmd:result>
            <gmd:DQ_ConformanceResult>
                <xsl:choose>
                    <xsl:when test="not(int:GM03_2_1Comprehensive.Comprehensive.CI_Citation)">
    ...
    <xsl:template mode="DataQualityReport" match="int:GM03_2_1Comprehensive.Comprehensive.DQ_QuantitativeResult">
        <gmd:result>
    ...
    <xsl:template mode="DataQuality" match="int:GM03_2_1Core.Core.LI_Lineage">
        <gmd:lineage>
            <gmd:LI_Lineage>
                <xsl:apply-templates mode="DataQuality"/>
            </gmd:LI_Lineage>
    ...
    <xsl:template mode="DataQuality" match="int:GM03_2_1Comprehensive.Comprehensive.LI_ProcessStep">
        <gmd:processStep>
            <xsl:apply-templates mode="ProcessStep" select="." />
        </gmd:processStep>
    </xsl:template>

    <xsl:template mode="ProcessStep" match="int:GM03_2_1Comprehensive.Comprehensive.LI_ProcessStep">
        <gmd:LI_ProcessStep>
    ...
    <xsl:template mode="DataQuality" match="int:GM03_2_1Comprehensive.Comprehensive.LI_Source">
        <gmd:LI_Source>
            <xsl:apply-templates mode="text" select="int:description"/>
            ...
            <xsl:apply-templates mode="DataQuality" select="int:GM03_2_1Core.Core.EX_Extent"/>
    ...
    <xsl:template mode="DataQuality" match="int:sourceStep">
        <gmd:sourceStep>
    ...
    <xsl:template mode="DataQuality" match="int:GM03_2_1Core.Core.EX_Extent">
        <gmd:sourceExtent>
            <gmd:EX_Extent>
    ...
    <xsl:template mode="DataQuality" match="int:GM03_2_1Comprehensive.Comprehensive.DQ_Scope|int:GM03_2_1Core.Core.DQ_Scope">
        <gmd:scope>
            <gmd:DQ_Scope>
                ...
                <xsl:apply-templates mode="DataQuality" select="int:GM03_2_1Comprehensive.Comprehensive.DQ_Scopeextent/*"/>
                <xsl:apply-templates mode="DataQuality" select="int:GM03_2_1Core.Core.MD_ScopeDescription|int:GM03_2_1Comprehensive.Comprehensive.MD_ScopeDescription"/>
            </gmd:DQ_Scope>
        </gmd:scope>
    </xsl:template>
    ...
    <xsl:template mode="DataQuality" match="int:GM03_2_1Core.Core.MD_ScopeDescription|int:GM03_2_1Comprehensive.Comprehensive.MD_ScopeDescription">
        <gmd:levelDescription>
            <gmd:MD_ScopeDescription>
