<xsl:stylesheet version="1.0"
    ...
    <xsl:template mode="Identifier" match="int:GM03_2_1Core.Core.MD_Identifier/int:code/int:GM03_2_1Core.Core.PT_FreeText/int:textGroup">
        <gmd:MD_Identifier>
            <gmd:code>
                <gco:CharacterString>
                    <xsl:value-of select="int:GM03_2_1Core.Core.PT_Group/int:plainText[1]"/>
                </gco:CharacterString>
            </gmd:code>
        </gmd:MD_Identifier>
    </xsl:template>
