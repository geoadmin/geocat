...
-->
<xsl:stylesheet xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:srv="http://www.isotc211.org/2005/srv"
                xmlns:che="http://www.geocat.ch/2008/che" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
...
>
  ...
  <xsl:template
    match="che:CHE_SV_ServiceIdentification|srv:SV_ServiceIdentification|*[gco:isoType='srv:SV_ServiceIdentification']"
    priority="200" mode="copy">
    <xsl:copy>
      <xsl:copy-of select="@*"/>
      ...
      <xsl:copy-of
        select="srv:coupledResource[srv:SV_CoupledResource/srv:identifier/gco:CharacterString=$uuid and srv:SV_CoupledResource/gco:ScopedName!=$layerName]"/>
