        ...
        <gmd:MD_Distribution>
          ...
          <gmd:transferOptions>
            <gmd:MD_DigitalTransferOptions>
              <xsl:copy-of
                select="gmd:distributionInfo/gmd:MD_Distribution/gmd:transferOptions/gmd:MD_DigitalTransferOptions/gmd:unitsOfDistribution/*"/>
              <xsl:copy-of
              ...
              <xsl:for-each select="/root/srvInfos/serviceInfo">
                <gmd:onLine>
              ...
              <xsl:copy-of
                select="gmd:distributionInfo/gmd:MD_Distribution/gmd:transferOptions/gmd:MD_DigitalTransferOptions/gmd:offLine/*"/>
            </gmd:MD_DigitalTransferOptions>
          </gmd:transferOptions>
        </gmd:MD_Distribution>
